...
public class OpenMeteoCurrentWeather : ICurrentWeatherService
{
    private readonly IHttpClientFactory httpClientFactory;
    private readonly string apiKey;

    public OpenMeteoCurrentWeather(IHttpClientFactory httpClientFactory, IConfiguration configuration)
    {
